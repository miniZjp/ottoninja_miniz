...
#define TAG "OttoNinja"

class OttoNinjaBoard : public WifiBoard {
private:
 
    Button boot_button_;
    LcdDisplay* display_;
    PowerManager* power_manager_;
    httpd_handle_t webserver_handle_;
    ...
    void InitializeWebServer() {
        ...
        webserver_handle_ = webserver_start();
        if (webserver_handle_ == NULL) {
    ...
    void StartNetwork() override {
        ...
        // Initialize robot control after WiFi is ready
        ...
        ESP_LOGI(TAG, "====================================");
        ESP_LOGI(TAG, "   miniZninja READY!");
        ESP_LOGI(TAG, "=====================================");
    }

public:
    OttoNinjaBoard() :
        boot_button_(BOOT_BUTTON_GPIO), webserver_handle_(nullptr) {
        InitializeSpi();
